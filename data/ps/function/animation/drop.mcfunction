...
execute on passengers run ride @s mount @n[type=text_display,distance=..1,tag=new_dropped]

#trigger dropped function
execute as @n[type=text_display,distance=..1,tag=new_dropped] at @s run function ct:player/coin_land
