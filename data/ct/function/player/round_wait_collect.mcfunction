...
execute at @e[type=marker,tag=table_nextlvl_slot_title] run summon text_display ~ ~ ~ {Tags:["next_level_hint"],text:'"本轮奖励"',alignment:"center",transformation:[0,100,0,0,0,0,100,0,100,0,0,0,0,0,0,60],background:0}
