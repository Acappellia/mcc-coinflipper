...
scoreboard players set #check_front_counter ct 0
...
execute if score #check_front_counter ct = #check_back_counter ct run scoreboard players set #round_check_result ct 1