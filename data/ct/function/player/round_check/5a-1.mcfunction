...
execute if data storage ct:tmp check_coin{ishead:1} if data storage ct:tmp check_coin_2{ishead:1} run scoreboard players set #round_check_result ct 1
execute if data storage ct:tmp check_coin{ishead:0} if data storage ct:tmp check_coin_2{ishead:0} run scoreboard players set #round_check_result ct 1