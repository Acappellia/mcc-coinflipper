...
execute if data storage ct:tmp check_coin{coin_id:12,ishead:1} run scoreboard players add #check_back_counter ct 1
execute if data storage ct:tmp check_coin{coin_id:12,ishead:0} run scoreboard players add #check_front_counter ct 1
