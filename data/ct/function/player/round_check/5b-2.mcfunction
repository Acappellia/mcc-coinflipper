...
execute if data storage ct:tmp check_coin{ishead:1} if data storage ct:tmp check_coin_2{ishead:0} run scoreboard players set #round_check_result_extra ct 1
execute if data storage ct:tmp check_coin{ishead:0} if data storage ct:tmp check_coin_2{ishead:1} run scoreboard players set #round_check_result_extra ct 1
execute if data storage ct:tmp check_coin{coin_id:12} run scoreboard players set #round_check_result_extra ct 1
execute if data storage ct:tmp check_coin2{coin_id:12} run scoreboard players set #round_check_result_extra ct 1