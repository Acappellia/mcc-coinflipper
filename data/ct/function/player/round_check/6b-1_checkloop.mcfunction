...
execute if score #check_prev_front ct matches 0 if data storage ct:tmp check_coin{ishead:0} run return run scoreboard players set #round_check_result ct 0
