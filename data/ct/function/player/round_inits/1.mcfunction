...
execute at @n[type=marker,tag=table_mainui_slot_center] run summon text_display ~ ~ ~ {Tags:["newbie_hint"],text:'"手持硬币右键桌面抛出"',alignment:"center",transformation:[100,0,0,0,0,0,100,0,0,-100,0,0,0,0,0,80],background:0}