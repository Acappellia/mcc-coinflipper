...
execute at @e[type=marker,tag=table_hint_slot_3b] run summon text_display ~ ~ ~ {Tags:["round_hint","round_hint3"],text:'"【奖励】正和反硬币数量相同，且最后一枚为正面"',alignment:"center",transformation:[0,0,-100,0,0,100,0,0,100,0,0,0,0,0,0,120],background:0}