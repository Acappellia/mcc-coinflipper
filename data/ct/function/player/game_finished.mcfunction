...
execute at @e[type=text_display,tag=landed_coin] run particle smoke ~ ~ ~ 0 0 0 0.02 5
...
execute if score #player_life ct matches ..0 at @n[type=marker,tag=table_mainui_slot_center] run summon text_display ~ ~ ~ {Tags:["main_ui"],text:'"你失败了…"',alignment:"center",transformation:[100,0,0,0,0,0,100,0,0,-100,0,0,0,0,0,80],background:0}
execute if score #player_life ct matches 1.. at @n[type=marker,tag=table_mainui_slot_center] run summon text_display ~ ~ ~ {Tags:["main_ui"],text:'"你是赢家"',alignment:"center",transformation:[100,0,0,0,0,0,100,0,0,-100,0,0,0,0,0,80],background:0}
...
execute if score #player_life ct matches 1.. at @n[type=marker,tag=table_mainui_slot_center] run playsound cointosser:victory player @a ~ ~ ~ 1 1
